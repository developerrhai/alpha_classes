...
async function seed() {
  ...
  try {
    ...
    const [adminResult] = await conn.query(
      ...
      ['Super Admin', 'admin@alphaclasses.com', defaultPassword, 'admin', 'Alpha Classes Institute']
    );
    ...
    const teachersData = [
      ['Math Teacher', 'math@alphaclasses.com', '["Math"]'],
      ['Science Teacher', 'science@alphaclasses.com', '["Physics", "Chemistry"]'],
      ['English Teacher', 'english@alphaclasses.com', '["English"]']
    ];
