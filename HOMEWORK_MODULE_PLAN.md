...
## PROJECT CONTEXT & CONSTRAINTS (Adapted for Alpha Classes)
...
*(Note: We already use `teacher_updates` in Alpha Classes, but here is the expanded ideal schema to match requirements)*
